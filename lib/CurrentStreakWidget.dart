    ...
    return Row(
      children: [
        ...
        Column(
          ...
          children: [const Text("CURRENT STREAK",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w700),),const SizedBox(height: 10),Text(habit.streaks== 1 ? "${habit.streaks} day" : "${habit.streaks} days",style: TextStyle(fontSize: 15,fontWeight: FontWeight.w500),)],
        ),
        const Spacer(),
        Container(
